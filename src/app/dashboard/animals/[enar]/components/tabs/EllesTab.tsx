        ...
        <BirthForm
          ...
          onSuccess={async () => {
            ...
            if (editingBirth?.id) {
              ...
              // 🆕 KATEGÓRIA ELLENŐRZÉS ELLÉS SZERKESZTÉS UTÁN
              if (editingBirth.mother_enar) {
                console.log('🔄 Kategória ellenőrzés ellés szerkesztés után:', editingBirth.mother_enar);
                await handleMotherCategoryReset(editingBirth.mother_enar);
              }
